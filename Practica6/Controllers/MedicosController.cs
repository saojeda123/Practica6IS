...
namespace Practica6.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicoId,Nombre,Especialidad,Email,Telefono")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicoId,Nombre,Especialidad,Email,Telefono")] Medico medico)
        {
